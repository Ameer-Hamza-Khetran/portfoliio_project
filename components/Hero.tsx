    ...
    return (
        <div className='pb-20 pt-36'>
            <div>
                ...
                <Spotlight className='top-10 left-full h-[80vh] w-[50vw]' fill='#812ec9' />
                <Spotlight className='top-28 left-80 h-[80vh] w-[50vw]' fill='#0a10c9' />
            </div>
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    ...
                    <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                        Hi, I&apos;m Ameer Hamza Khetran, a Frontend Developer!
                    </p>
                    <a target='_blank' href='https://www.linkedin.com/in/ameer-hamza-khetran/'>
